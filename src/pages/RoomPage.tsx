      ...
      <Header>
        <div className="flex items-center gap-6">
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-64 bg-slate-800 border border-slate-700 rounded-xl shadow-xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-100 ring-1 ring-black/5">
                  ...
                  <button
                    ...
                    className="flex items-center justify-start space-x-2 w-full text-left px-4 py-3 cursor-pointer text-red-400 hover:bg-slate-700 hover:text-red-300 transition-colors flex items-center gap-2 font-medium"
                  >
          ...
          <button
            ...
            className="flex items-center gap-2 border-2 border-blue-500/50 text-blue-400 hover:bg-blue-500/10 hover:border-blue-500 hover:text-blue-300 rounded-xl px-5 py-2.5 font-bold transition-all active:scale-95 cursor-pointer"
          >
